...
public class Logic {
    ...
    public static Highscore getHighscore() {
        ...
        ArrayList<Scores> scores = db.getHigh();
        ArrayList<Integer> list = new ArrayList<>();



        //int HighscoreArray[] = {model.Highscore.getNo1(), model.Highscore.getNo2(),
        //model.Highscore.getNo3(), model.Highscore.getNo4(), model.Highscore.getNo5()};

        for(int i = 0 ; i < scores.size() ; i++)
        {
            list.add(scores.get(i).getScore());
        ...
        highscore.setNo1(list.get(0));
        highscore.setNo2(list.get(1));
        highscore.setNo3(list.get(2));
        highscore.setNo4(list.get(3));
        highscore.setNo5(list.get(4));

        System.out.println(highscore.getNo1());
        System.out.println(highscore.getNo2());
        System.out.println(highscore.getNo3());
        System.out.println(highscore.getNo4());
        System.out.println(highscore.getNo5());
